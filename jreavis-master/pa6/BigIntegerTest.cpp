...
int main(){
   ...
   cout << "New Big Integer K: ";
   cout << K << endl;

   cout << "K's sign: " << K.sign() << endl;
   cout << "Negating... done!" << endl;
   K.negate();
   cout << "New sign: " << K.sign() << endl;

   string s8 = "5";
   BigInteger L = BigInteger(s8);

   if(K.compare(L) == 1) {
    cout << "K is greater than L" << endl;
   } else if(K.compare(L) == -1){
    cout << "K is less than L" << endl;
   }
