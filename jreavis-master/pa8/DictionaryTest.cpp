...
int main(){
   ...
   cout << "Checking dictionary for key 'cul'..." << endl;
   if(B.contains("cul")) {
      cout << "Key present!" << endl;
      cout << "Key value: " << B.getValue("cul") << endl;
   } else {
   ...
   Dictionary C = B;
   if(C.equals(B)) {
      cout << "C and B are the same!" << endl;
   } else {
      cout << "C and B are not the same!" << endl << endl;
   }
   Dictionary D = B;
   ...
   cout << "Clearing dictionary D..." << endl;
   cout << "D after clear():" << endl;
   D.end();
   D.clear();
   cout << D << endl;

   // check operator==()
   cout << "A==B is " << (A==B?"true":"false") << endl;//incorrect
   cout << "B==C is " << (B==C?"true":"false") << endl;
   cout << "C==A is " << (C==A?"true":"false") << endl << endl;//incorrect
